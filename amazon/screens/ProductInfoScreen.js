...
const ProductInfoScreen = () => {
    ...
    return (
        <ScrollView style={{marginTop: 55, flex: 1, backgroundColor: 'white'}} showsVerticalScrollIndicator={false}>
                    ...
                    <ImageBackground style={{width, height, marginTop: 25, resizeMode: 'contain'}} source={{uri:item}} key={index}>
                        <View style={{padding: 20, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between'}}>
                            <View style={{width: 40, height: 40, borderRadius: 20, backgroundColor: '#C60C30', justifyContent: 'center', alignItems: 'center', flexDirection: 'row'}}>
                                <Text style={{color: 'white', textAlign: 'center', fontWeight: '600', fontSize: 12}}>28% off</Text>
                            </View>
            ...
            <View style={{padding: 10}}>
                <Text style={{fontSize: 15, fontWeight: 'bold', marginVertical: 5}}>Total: R${route.params.price}</Text>
                <Text style={{color: '#00CED1'}}>Frete GRÁTIS Comprando até 12H</Text>

                <View style={{flexDirection: 'row', marginVertical: 5, alignItems: 'center', gap: 5}}>
                    <Ionicons name='location' size={24} color='black' />
                    <Text style={{fontSize: 15, fontWeight: '500'}}>Entregar para Vinícius - Rua A 98</Text>
                </View>
            </View>

            <Text style={{color: 'green', marginHorizontal: 10, fontWeight: '500'}}>Em Estoque</Text>
